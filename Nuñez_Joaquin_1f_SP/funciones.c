...
int menu ( )
{
    ...
    system("cls") ;
    printf("**********************************************************************************************************************\n");
    printf("Menu:\n1.Leer un archivo y guardarlo en un linkedList de entidadades eDominio\n2. Setear el campo tipo de cada uno de los dominios leidos segun sea Automovil o Moto.\n\n\n5. Salir\n");
    printf("**********************************************************************************************************************\n");
