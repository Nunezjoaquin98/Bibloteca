...
{
    printf("\n\nLEGAJO\tAPELLIDO\tNOMBRE\tSEXO\tSALARIO\tFECHA DE INGRESO\tSECTOR\n");
...
int addEmployee(eEmployee list[], int len)
{
    ...
    if(list != NULL && len > 0)
    {
        ...
        else
        {
            ...
            newEmployee.ingreso = fechaDeIngreso;
